...
def mosaic_f(img, type):
    ...
    cv2.imwrite("./img/mosaic_" + type + ".bmp", img_mosaic)
    ...
    for i in range(height):
        for j in range(width):
            if ((i % 6 == 0 or i % 6 == 3) and (j % 6 == 0 or j % 6 == 3)) or (
                ...
                img[i][j] = [0, img[i][j][1], 0]
            elif (i % 6 == 0 and (j % 6 == 2 or j % 6 == 4)) or ((i % 6 == 1 or i % 6 == 5) and j % 6 == 0) or (
                    (i % 6 == 2 or i % 6 == 4) and j % 6 == 3) or (i % 6 == 3 and (j % 6 == 1 or j % 6 == 5)):  # blue
                img[i][j] = [0, 0, img[i][j][2]]
            elif ((i % 6 == 1 or i % 6 == 5) and j % 6 == 3) or ((i % 6 == 2 or i % 6 == 4) and j % 6 == 0) or (
                    i % 6 == 3 and (j % 6 == 2 or j % 6 == 4)) or (i % 6 == 0 and (j % 6 == 1 or j % 6 == 5)):  # red
                img[i][j] = [img[i][j][0], 0, 0]
    return img
