...
private:
	...
	int partition(std::vector<Movie> &data, int left, int right);
...
public:
	...
	std::vector<Movie> quickSort(std::vector<Movie> &data, int left, int right);
	...
	std::vector<Movie> insertionSort(std::vector<Movie> &data);
