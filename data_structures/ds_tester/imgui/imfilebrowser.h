...
enum ImGuiFileBrowserFlags_ {
	...
	ImGuiFileBrowserFlags_HideRegularFiles = 1
			<< 8, // hide regular files when ImGuiFileBrowserFlags_SelectDirectory is enabled
...
inline void ImGui::FileBrowser::Display() {
	...
	{
		BeginChild(
				"ch", ImVec2(0, -reserveHeight), true,
		...
		for (unsigned int rscIndex = 0;
				 rscIndex < fileRecords_.size(); ++rscIndex) {
